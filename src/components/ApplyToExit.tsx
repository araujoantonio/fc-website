    ...
    <section className="min-h-screen bg-primary-dark-brown">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center mb-20">
          <h1 className="text-4xl md:text-6xl font-thin text-text-on-dark mb-8 tracking-tight">
            Ready to Exit?
          </h1>
          <div className="text-xl md:text-2xl text-text-on-dark-muted max-w-4xl mx-auto leading-relaxed font-light space-y-2">
            <p>Our process is fast,</p>
            <p className="font-normal">simple</p>
            <p>and transparent.</p>
          </div>
        </div>
        ...
        <div className="mb-20">
          <h2 className="text-3xl md:text-4xl font-thin text-text-on-dark mb-12 text-center tracking-tight">
            Here's how it works:
          </h2>
          <div className="bg-primary-light rounded-2xl p-8 md:p-12 shadow-2xl">
            <p className="text-lg text-text-on-light leading-relaxed font-light mb-6">
              First, you'll answer some questions about the business in the form below...
            </p>
            <p className="text-lg text-text-on-light leading-relaxed font-light">
              We'll review your application asap and respond with an answer within 24 hours, business days and weekends included.
            </p>
          </div>
        </div>

        {/* Acquisition Application CTA */}
        <div className="text-center mb-20">
          <div className="bg-primary-dark-blue rounded-2xl p-12 shadow-2xl">
        ...
        <div className="space-y-16">
          ...
          <div className="bg-primary-light rounded-xl p-8 md:p-12 shadow-lg">
            <h4 className="text-2xl font-thin text-text-on-light mb-6 tracking-wide">
              Initial Review
            </h4>
            <p className="text-lg text-text-on-light-muted leading-relaxed font-light">
          ...
          <div className="bg-primary-contrast rounded-xl p-8 md:p-12 shadow-lg">
            <h4 className="text-2xl font-thin text-text-on-light mb-6 tracking-wide">
              Discovery Call
            </h4>
            <div className="space-y-4 text-lg text-text-on-light-muted leading-relaxed font-light">
              <p>
          ...
          <div className="bg-primary-dark-blue rounded-xl p-8 md:p-12 shadow-lg">
            <h4 className="text-2xl font-thin text-text-on-dark mb-6 tracking-wide">
              Letter of Intent
            </h4>
            <p className="text-lg text-text-on-dark-muted leading-relaxed font-light">
          ...
          {/* Step 5: Expedited Process */}
          <div className="bg-primary-contrast rounded-xl p-8 md:p-12 shadow-lg">
            <h4 className="text-2xl font-thin text-text-on-light mb-6 tracking-wide">
              Our Advantage: Expedited Process
            </h4>
            <div className="space-y-4 text-lg text-text-on-light-muted leading-relaxed font-light">
              <p>
              ...
              <p className="font-medium text-text-on-light">
                Our philosophy is: the faster we can all move forward, the better for you, for the customers and for the employees means better for us.
              </p>
            </div>
          </div>
          ...
          {/* Congratulations */}
          <div className="bg-interactive-primary rounded-xl p-8 md:p-12 shadow-lg text-center">
            <h4 className="text-3xl font-thin text-text-on-gold mb-4 tracking-wide">
